...
echo " 次の手順 (必ずこの順で):"
echo ""
echo "   1. このディレクトリで claude を起動"
echo "      cd ${repo_dir}"
echo "      claude"
echo ""
echo "   2. Claude Code セッション内で:"
echo "      /shortvideo-loop my-first-video"
echo ""
echo " ※ 必ず ${repo_dir} で claude を起動してください"
echo "    別ディレクトリで起動すると 3 エージェントが見つかりません"
echo ""
